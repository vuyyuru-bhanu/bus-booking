...
-- Users table for passengers and admins
CREATE TABLE users (
...
CREATE TABLE routes (
    ...
    departure_time VARCHAR(255) NOT NULL, -- Consider DATETIME for precise scheduling
...
-- Bus images table for storing bus image URLs
...
-- Payments table for tracking payments (added for completeness)
...
-- Create view for admin dashboard (booking summary)
...
INSERT INTO users (email, password, name, role)
VALUES (
    'passenger@busbooking.com',
    '$2a$10$examplehashedpassword0987654321', -- Hashed password for testing
    'John Doe',
    'user'
);
...
VALUES 
    ('New York', 'Boston', '2025-07-15 08:00:00', 240), -- 4 hours
    ('Chicago', 'Detroit', '2025-07-15 09:00:00', 300); -- 5 hours
